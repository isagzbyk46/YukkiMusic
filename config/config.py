...
BOT_TOKEN = getenv("7685839835:AAHsKEGSRte6WioraQyI_pmleAky4ih_9Qg")
...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/isagzbyk46/YukkiMusic",
)
...
LOG_GROUP_ID = getenv("LOG_GROUP_ID", "-1002343642090")


# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "7230845621").split())
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/dertkonagi"
)  # Example:- https://t.me/TheTeamVivek
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/gitarist40"
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/isagzbyk46/YukkiMusic")
